...
public class MesaIconClicked : MonoBehaviour
{
    ...
    /// <summary>
    /// Al hacer clic en el icono de la mesa en la UI, se activa esta función
    /// </summary>
    ...
    private void Update()
    {
        // Si la mesa se ha creado, se activa la función
        if (newMesa != null)
        {
            FollowMouse();
    ...
    private void CreateObjectAtMousePosition()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            sombra.transform.parent = newMesa.transform;
        }
}
    ...
    private void FollowMouse()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            sombra.transform.position = newMesa.transform.position;
        }
    }
    ...
    private void PlaceObjectAtMouseClick()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            if (hit.collider.CompareTag("Suelo"))
            {
                ...
                newMesa.transform.position = hit.point;
