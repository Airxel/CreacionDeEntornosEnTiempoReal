...
{
    [SerializeField]
    GameObject planta, crearText;

    [SerializeField]
    GameObject newPlanta;
    ...
    /// <summary>
    /// Al hacer clic en el icono de la planta en la UI, se activa esta función
    /// </summary>
    ...
    private void Update()
    {
        // Si la planta se ha creado, se activa la función
        if (newPlanta != null)
        {
            FollowMouse();
    ...
    private void CreateObjectAtMousePosition()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            sombra.transform.parent = newPlanta.transform;
        }
    }
    ...
    private void FollowMouse()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            sombra.transform.position = newPlanta.transform.position;
        }
    }
    ...
    private void PlaceObjectAtMouseClick()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            if (hit.collider.CompareTag("Suelo"))
            {
                ...
                newPlanta.transform.position = hit.point;
